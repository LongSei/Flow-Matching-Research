...
def normalization(channels):
    ...
    """
    if channels % 32 == 0:
        # Use GroupNorm32 for channels that are multiples of 32.
        # This is a workaround for a bug in PyTorch 1.5 that causes
        # GroupNorm to fail with large channel counts.
        # See
